<template>
  <div id="noteDetail">
    <NoteNav :item='openNote' @navChangeFav='changeFaver(nowCurrent.id)' @navgoBack='$router.go(-1)' @navChangeEdit='changeEdit(nowCurrent),changeNoteContent(msg)'/>
    <div id="openNote">
...
export default {
  ...
  methods:{
    ...mapMutations(["setCurrent","changeFaver","changeEdit","changeNoteContent"]),
  },
  mounted(){
